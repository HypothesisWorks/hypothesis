...
.. doctest::
    ...
    Shrunk example to [-1198601713, -67, 116]
    Shrunk example to [-1198601713, -67]
    Shrunk example to [-1198601713]
    Shrunk example to [-10852]
    Shrunk example to [-10054]
    Shrunk example to [-27525]
    Shrunk example to [23792]
    Shrunk example to [98]
    Shrunk example to [-24]
    Shrunk example to [-2]
    Shrunk example to [-72]
    Shrunk example to [119]
