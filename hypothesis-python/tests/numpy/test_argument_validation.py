...
@pytest.mark.parametrize(
    ...
    [
        ...
        e(nps.basic_indices, shape=(0, 0), min_dims=3),
        e(nps.basic_indices, shape=(0, 0), min_dims=50, allow_newaxis=True),
        e(nps.basic_indices, shape=(0, 0), max_dims=50, allow_newaxis=True),
        e(nps.basic_indices, shape=(), min_dims=1),
