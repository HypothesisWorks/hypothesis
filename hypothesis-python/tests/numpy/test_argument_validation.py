...
@pytest.mark.parametrize(
    ...
    [
        ...
        e(nps.broadcastable_shape, shape="a"),
        e(nps.broadcastable_shape, shape=(2, 2), min_side="a"),
        e(nps.broadcastable_shape, shape=(2, 2), min_dims="a"),
        e(nps.broadcastable_shape, shape=(2, 2), max_side="a"),
        e(nps.broadcastable_shape, shape=(2, 2), max_dims="a"),
        e(nps.broadcastable_shape, shape=(2, 2), min_side=-1),
        e(nps.broadcastable_shape, shape=(2, 2), min_dims=-1),
        e(nps.broadcastable_shape, shape=(2, 2), min_side=1, max_side=0),
        e(nps.broadcastable_shape, shape=(2, 2), min_dims=1, max_dims=0),
    ],
)
