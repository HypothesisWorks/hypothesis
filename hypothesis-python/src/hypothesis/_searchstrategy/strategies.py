...
from hypothesis._control import assume, reject, _current_build_context
from hypothesis._settings import note_deprecation
from hypothesis._internal.compat import hrange, bit_length
from hypothesis._utils.conventions import UniqueIdentifier
from hypothesis._internal.lazyformat import lazyformat
from hypothesis._internal.reflection import get_pretty_function_description
from hypothesis._internal.conjecture.utils import LABEL_MASK, \
...
class SearchStrategy(object):
    ...
    def flatmap(self, expand):
        ...
        This method is part of the public API.
        """
        from hypothesis._searchstrategy.flatmapped import FlatMapStrategy
