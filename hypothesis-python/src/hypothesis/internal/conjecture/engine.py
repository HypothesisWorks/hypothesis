...
class ConjectureRunner:
    ...
    def record_for_health_check(self, data: ConjectureData) -> None:
        ...
        if state.invalid_examples == max_invalid_draws:
            fail_health_check(
                self.settings,
                "It looks like your strategy is filtering out a lot of inputs: "
                ...
                "filtering will distort the domain and/or distribution of your test, "
        ...
        if (
            ...
            fail_health_check(
                ...
                "\n"
                "1. Your strategy could be generating too much data per input. "
                "Try decreasing the amount of data generated, for example by "
                "decreasing the minimum size of collection strategies like "
                "st.lists()."
                "\n"
                ...
                "if you intersperse @st.composite or st.data() with an expensive "
    ...
    def generate_new_examples(self) -> None:
        ...
        if zero_data.status == Status.OVERRUN or (
            ...
            fail_health_check(
                self.settings,
                "The smallest natural input for your test is very "
                "large. This makes it difficult for Hypothesis to generate "
                "good inputs, especially when trying to shrink failing inputs."
                "\n\n"
                "Consider reducing the size of your inputs if it is "
                "of a fixed size. You could also fix this by introducing "
                "default values for some strategies. For example, could you "
