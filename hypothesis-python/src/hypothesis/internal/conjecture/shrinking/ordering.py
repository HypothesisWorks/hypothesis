...
class Ordering(Shrinker):
    ...
    Will not change the length or the contents, only tries to change the
    order of elements within the sequence.
    """
    ...
    def short_circuit(self):
        # If we can flat out sort the target then there's nothing to do.
