...
DRAW_BOOLEAN_LABEL = calc_label_from_name("draw_boolean() in PrimitiveProvider")
    ...
    def _draw_bounded_integer(
        ...
        *,
        ...
        if lower == upper:
            ...
            #
            # TODO draw_bits isn't recorded in DataTree anymore, and soon won't
            # have an impact on shrinking either. I think after shrinking is
            # ported this hack can be removed, as we now always write the result
            # of draw_integer to the observer, even when it's trivial.
            self._cd.draw_bits(1, forced=0)
            return int(lower)
...
class ConjectureData:
    ...
    def draw_integer(
        ...
        *,
        ...
        self.start_example(DRAW_INTEGER_LABEL)
