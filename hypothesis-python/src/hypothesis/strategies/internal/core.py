...
from hypothesis.strategies.internal import SearchStrategy, check_strategy
from hypothesis.strategies.internal.collections import (
...
from hypothesis.strategies.internal.datetime import (
    DateStrategy,
    DatetimeStrategy,
    TimedeltaStrategy,
)
from hypothesis.strategies.internal.deferred import DeferredStrategy
from hypothesis.strategies.internal.functions import FunctionStrategy
from hypothesis.strategies.internal.lazy import LazyStrategy
from hypothesis.strategies.internal.misc import JustStrategy
from hypothesis.strategies.internal.numbers import (
    BoundedIntStrategy,
    FixedBoundedFloatStrategy,
    FloatStrategy,
    WideRangeIntStrategy,
)
from hypothesis.strategies.internal.recursive import RecursiveStrategy
from hypothesis.strategies.internal.shared import SharedStrategy
from hypothesis.strategies.internal.strategies import OneOfStrategy, SampledFromStrategy
from hypothesis.strategies.internal.strings import (
...
if False:
    ...
    from hypothesis.strategies.internal.strategies import T, Ex  # noqa
...
def from_regex(regex, fullmatch=False):
    ...
    from hypothesis.strategies.internal.regex import regex_strategy
    ...
    **kwargs  # type: Union[SearchStrategy[Any], InferType]
    ...
    if required or to_infer:
        if isclass(target) and attr.has(target):
            ...
            from hypothesis.strategies.internal.attrs import from_attrs
