...
def from_typing_type(thing):
    ...
    # 3.14+ removes typing.ByteString. This was the only reason we previously
    # generated bytes for Collection[int]. There is no equivalent for
    # typing.ByteString in 3.14+, but we would still like to generate bytes
    # for Collection[int]. Special case that here.
    #
    # checking for try_issubclass(thing, collections.abc.Collection) here
    # disallows this case for non-collection types like Type[int].
    if (
