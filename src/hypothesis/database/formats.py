...
class Format(object):
    ...
    hypothesis.database.converter) and some other type. The type can be any
    thing you like, but the most likely use cases are text or binary encodings.
    """
...
class JSONFormat(Format):
    """
    A format that uses the natural encoding to Python's slightly extended JSON+
